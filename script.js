document.addEventListener('DOMContentLoaded', () => {
    ...
    const nameEls = document.querySelectorAll('#team .card-badges strong, #team .card-badges b');
    nameEls.forEach(el => {
    ...
    if (!HAS_EVENT) {
        ...
        const getZonedDate = (tz) => {
            try {
                ...
                const target = new Date('2026-05-03T12:00:00'); 
                ...
                return new Date('2026-05-03T12:00:00-04:00'); 
            }
        };
    ...
    const revealEls = document.querySelectorAll('main section, .card, #faq .faq-item, #team .team-group, #team .team-group:not(.role-definitions) ul li, #events .event-countdown, #community .housing-info, #community .boost-perks');
    if (revealEls.length) {
        ...
        const onParallax = () => {
            if (!ticking) {
                ...
                requestAnimationFrame(() => {
                    ...
                    hero.style.backgroundPosition = `center calc(top + ${-y * 0.12}px)`;
                    ticking = false;
                });
            }
        };
    ...
    class Accordion {
        constructor(el) {
            ...
            this.content = el.querySelector('.category-content-wrapper');
            this.animation = null;
    ...
    document.querySelectorAll('details.staff-category').forEach((el) => {
        new Accordion(el);
    });
});
